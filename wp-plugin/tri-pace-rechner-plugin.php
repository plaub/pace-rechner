...
function func_load_pace_rechner_scripts()
{
    ...
    // Register in dependency order - base chunk first
                                                                                        wp_register_script('pace-rechner_script_0', plugin_dir_url(__FILE__) . 'dist/_nuxt/zVP15srr.js', array(), $version, true);
...
function func_wp_pace_rechner()
{
    ...
    wp_enqueue_style('pace-rechner', plugin_dir_url(__FILE__) . 'dist/_nuxt/entry.CfuZ1Y3P.css', null, $version);

    //Build String
    $str = '<div id="__nuxt"></div><script type="application/json" data-nuxt-data="nuxt-app" data-ssr="false" id="__NUXT_DATA__">[{"prerenderedAt":1,"serverRendered":2},1762887448539,false]</script><script>window.__NUXT__={};window.__NUXT__.config={public:{},app:{baseURL:"/",buildId:"6e979d1d-183f-4e4f-88b0-c3cefb186388",buildAssetsDir:"' . plugin_dir_url(__FILE__) . 'dist/_nuxt/",cdnURL:""}}</script>';
