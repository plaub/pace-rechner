...
function func_load_pace_rechner_scripts()
{
    ...
    // Register in dependency order - base chunk first
                                                                                            wp_register_script('pace-rechner_script_0', plugin_dir_url(__FILE__) . 'dist/_nuxt/DIWYlG_o.js', array(), $version, true);
...
function func_wp_pace_rechner()
{
    ...
    wp_enqueue_style('pace-rechner', plugin_dir_url(__FILE__) . 'dist/_nuxt/entry.Bvo7-lUL.css', null, $version);

    //Build String
    $str = '<div id="__nuxt"></div><script type="application/json" data-nuxt-data="nuxt-app" data-ssr="false" id="__NUXT_DATA__">[{"prerenderedAt":1,"serverRendered":2},1762889957676,false]</script><script>window.__NUXT__={};window.__NUXT__.config={public:{},app:{baseURL:"/",buildId:"f0c467d6-4938-4386-8772-d9312405a3ae",buildAssetsDir:"' . plugin_dir_url(__FILE__) . 'dist/_nuxt/",cdnURL:""}}</script>';
